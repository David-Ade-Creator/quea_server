...
const router = express.Router(); // Load Controllers
...
router.post("/googleLogin", googleLoginController); //router.get("/user/:id", readUserProfileController);

router.post("/facebookLogin", facebookLoginController); //router.put("/user/:id/updateprofile", updateUserProfileController);
